...
Defining languages:
```{r define_langs}
#Croatian russian eng aust

target_langs<-c("English (American)","Italian","Norwegian", "Turkish", "Swedish", "Danish", "Dutch","French (French)","French (Quebecois)", "Portuguese (European)","Hungarian","Spanish (Mexican)", "Spanish (European)",  "German")

langs_with_n_affix = c("Spanish (Mexican)", "French (French)", "French (Quebecois)", "Spanish (European)", "German", "Swedish", "Portuguese (European)", "Hungarian")
